...
var CustomDictionaryManager = class {
  constructor(app, pluginDir, language = "en") {
    this.dictionary = {};
    this.app = app;
    this.filePath = (0, import_obsidian3.normalizePath)(`${pluginDir}/assets/custom-synonyms-${language}.json`);
  }
  async load() {
    try {
      try {
...
var AddSynonymModal = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian4.Setting(contentEl).setName(this.tr.addSynonymTitle(this.word)).setHeading();
...
var SynonymerSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName(tr.settingsHeading).setHeading();
